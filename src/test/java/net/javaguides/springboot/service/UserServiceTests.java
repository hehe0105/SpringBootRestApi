...
public class UserServiceTests {
    ...
    public void givenEmployeeObject_whenSaveEmployee_thenReturnEmployeeObject(){
        ...
        given(userRepository.findByEmail(employee.getEmail()))
                .willReturn(Optional.empty());

        given(userRepository.save(employee)).willReturn(employee);
    ...
    public void givenEmployeesList_whenGetAllEmployees_thenReturnEmployeesList(){
        ...
        given(userRepository.findAll()).willReturn(List.of(employee,employee1));
    ...
    public void givenEmployeeId_whenGetEmployeeById_thenReturnEmployeeObject(){
        ...
        // when
        User savedEmployee = employeeService.getEmployeeById(employee.getId()).get();
    ...
    public void givenEmployeeObject_whenUpdateEmployee_thenReturnUpdatedEmployee(){
        ...
        // when -  action or the behaviour that we are going test
        User updatedEmployee = employeeService.updateEmployee(employee);
